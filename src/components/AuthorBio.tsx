...
export const AUTHORS: Record<Author["slug"], Author> = {
  "robby-hess": {
    ...
    yearsExperience: 20,
    bio: "Robby Hess has 20+ years in commercial insurance, most recently as Senior Client Manager at a top-50 national brokerage. He specializes in multifamily, mixed-use, and apartment-building schedules for investment property owners — placing all-risk property, GL, umbrella, EPLI, and earthquake DIC nationwide. He writes from the underwriter's desk forward.",
    expertise: [
      "Multifamily property insurance",
      "Apartment building schedules",
      "Investment property real estate insurance",
