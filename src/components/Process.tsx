...
function StepPanel({
  ...
  return (
    ...
    >
      ...
      <div className="container" style={{ paddingBottom: 16, borderBottom: `1px solid ${inverted ? "var(--paper-3)" : "var(--ink)"}`, display: "grid", gridTemplateColumns: "1fr auto", alignItems: "baseline" }}>
        <span
          style={{
            fontFamily: "var(--font-mono)",
            fontSize: 11,
            ...
            textTransform: "uppercase",
            color: inverted ? "var(--ember)" : "var(--ember)",
          }}
        >
          Stage · {step.n} of 03
        </span>
        ...
        >
          {String(4 + index).padStart(2, "0")} / 06
        </span>
      </div>
      ...
      <div className="container" style={{ flex: 1, display: "flex", alignItems: "center", paddingBlock: "64px 32px" }}>
        <motion.div
          ...
          variants={reveal}
        >
          {/* XL graphic numeral — bleeds left, parallax */}
          <div className="col-3 step-numeral" style={{ display: "flex", alignItems: "flex-start" }}>
          ...
          <div
            className="col-7 start-5 step-text"
          ...
          >
            ...
            <div
              style={{
                marginTop: 16,
                paddingTop: 12,
                borderTop: `1px solid ${inverted ? "var(--paper-3)" : "var(--ink-3)"}`,
                fontFamily: "var(--font-mono)",
                fontSize: 11,
      ...
      <style>{`
        @media (max-width: 900px) {
          .step-row { row-gap: 32px; }
          .step-row .step-numeral,
          .step-row .step-text { grid-column: 1 / -1 !important; }
        }
      `}</style>
    </div>
  );
